...
urlpatterns = [
    ...
    path('admin_dashboard/issue_certificate/<int:student_id>/', views.issue_certificate, name='issue_certificate'),
    path('admin_dashboard/certificate/<int:certificate_id>/', views.download_certificate, name='download_certificate'),
